  ...
  return (
    <div className="min-h-screen  flex items-center justify-center p-4 w-full ">
      ...
      <div className="bg-white p-8 rounded-lg shadow-lg w-full max-w-2xl">
        <h1 className="text-2xl font-bold text-center mb-6 text-gray-800">Reserva de Cancha Multiple</h1>
        <form onSubmit={handleSubmit} className="space-y-4">
          <h2 className="text-lg font-semibold text-gray-700 mt-6 mb-2">Información de Contacto</h2>
          <div>
            <label htmlFor="clientName" className="block text-sm font-medium text-gray-700">Nombres Completo</label>
            <input
              type="text"
              id="clientName"
              name="clientName"
